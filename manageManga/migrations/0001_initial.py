# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-01-15 02:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.FileField(upload_to=manageManga.funct.user_directory_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puntaje', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)], verbose_name='Puntaje')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Author')),
