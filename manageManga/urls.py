...
urlpatterns = [
    ...
    url(r'^mangas/$', views.MangaListAndFilterView.as_view(), name = 'list_of_mangas'),
    ...
    url(r'^mangas/(?P<manga_id>[0-9]+)/chapter/add$', views.ChapterAddView.as_view(), name = 'chapter_add'),
    url(r'^my$', views.ProfileView.as_view(), name='my_mangas')
